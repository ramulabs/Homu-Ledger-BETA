...
import { X, Trash2, Camera, ImagePlus, ChevronRight, ChevronDown, ArrowRightLeft, Check, Calendar, Repeat, Sparkles, Loader2, ScanLine, Zap } from "lucide-react";
...
import type { DbTransaction, DbCategory, DbWallet, DbHouseholdMembership, DbTransactionRule, RecurringFrequency } from "@/lib/types";
