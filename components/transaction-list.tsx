...
import { Camera, ArrowRightLeft, Repeat, Zap } from "lucide-react";
...
export default function TransactionList({ transactions, members, currency = "IDR", iconStyle = "3d", onTap, onCreateRule }: Props) {
  const tr = useT();
